...
function provinChange(selectedIndex){
    var city=document.getElementById("param_city");
    city.length=citys[selectedIndex].length;
    for(var i=0;i<city.length;i++){
        city.options[i].text=citys[selectedIndex][i];
        city.options[i].value=citys[selectedIndex][i];
    }
}
